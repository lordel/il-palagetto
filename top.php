...
<head>
  ...
  appartamenti, bed, breakfast, camere, villa">
    ...
    <meta name="description" content="Il Palagetto è un'antica casa in campagna
    da poco restaurata, ed a soli 3km dal centro di Firenze. A disposizione
    degli ospiti ci sono 3 camere con vista spettacolare ed uno spazioso
    appartamento. Produciamo e vendiamo olio extra vergine di ottima qualità.">
...
<nav class="amber accent-1" role="navigation">
    <div class="nav-wrapper container">
        <a id="logo-container" href="#" class="brand-logo">
            <object id="front-page-logo" type="image/svg+xml" data="img/logo.svg"
                    itemscope itemtype="http://schema.org/LocalBusiness"
                    itemprop="logo">Your browser does not support SVG
            </object>
        </a> <!--for regular desktop & tablet-->
        <ul class="right
	  hide-on-med-and-down">
            <li><a href="#" class="waves-effect waves-light">Camere</a></li>
            <li><a
                    href="#" class="waves-effect waves-light">Appartamento</a></li>
            <li><a
                    href="#" class="waves-effect waves-light">Listino</a></li>
            <li><a
                    href="#" class="waves-effect waves-light">Mappa</a></li>
            <li><a href="#"
                   class="waves-effect waves-light">Contatti</a></li>
            <li><a href="#"
                   class="waves-effect waves-light">Prenota</a></li>
        </ul>

        <!--for mobile-->
        <ul id="nav-mobile" class="side-nav amber lighten-5">
            <li><a href="#" class="waves-effect waves-yellow">Camere</a></li>
            <li><a
                    href="#" class="waves-effect waves-yellow">Appartamento</a></li>
            <li><a
                    href="#" class="waves-effect waves-yellow">Listino</a></li>
            <li><a
                    href="#" class="waves-effect waves-yellow">Mappa</a></li>
            <li><a
                    href="#" class="waves-effect waves-yellow">Contatti</a></li>
            <li><a
                    href="#" class="waves-effect waves-yellow">Prenota</a></li>
        </ul>
        <a href="#" data-activates="nav-mobile" class="button-collapse
	  waves-effect waves-light"><i class="mdi-navigation-menu"></i></a></div>
</nav>
<!--end navigation bar-->
